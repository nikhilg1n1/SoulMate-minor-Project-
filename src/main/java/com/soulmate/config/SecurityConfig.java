...
//                    auth.requestMatchers("/css/**", "/image/**", "/video/**", "/js/**", "/**","/home","form").permitAll()
//                            .anyRequest().authenticated());
//            http.formLogin(form -> form.loginPage("/form").usernameParameter("email").loginProcessingUrl("/login").successForwardUrl("/home").failureUrl("/form?error=true"));
